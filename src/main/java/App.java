import com.ProyectoFinalNicolas.ProyectoFinalNicolas.ProyectoFinalNicolasApplication;
...
public class App {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {SpringApplication.run(ProyectoFinalNicolasApplication.class, args);
        System.out.println("Esta es mi aplicacion spring");
        selectAnalista();
    }
